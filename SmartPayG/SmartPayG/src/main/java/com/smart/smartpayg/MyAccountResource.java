...
public class MyAccountResource {
    ...
    public String SearchOverage(String param) {
        ...
        try {
            ...
            resultList = DBHelper.ExecuteSqlSelectReturnMap("mls", strSql);
    ...
    public String SearchConsumeRecord(String param) {
        ...
        try {
            ...
            tempCount = DBHelper.ExecuteSqlSelectOne("mls", strSqlCount);

            resultList = DBHelper.ExecuteSqlSelectReturnMap("mls", strSql);
            return formationResult.formationResult(ResponseResultCode.Success, signModel.token, new ExecuteResultParam(resultList, tempCount, true));
